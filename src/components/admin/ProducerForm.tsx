...
export function emptyProducerForm(): ProducerFormData {
  return {
    email: "",
    password: "",
    name: "",
...
export function ProducerForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="mx-auto max-w-2xl space-y-6">
      ...
      />
      <Input
        label="E-mail (login produtor.uaitickets.com.br)"
        type="email"
        value={form.email}
      ...
      <fieldset>
        <legend className="text-sm font-semibold text-slate-900">Eventos vinculados</legend>
        <p className="mt-1 text-xs text-slate-500">
          O produtor vê métricas e emite cortesias apenas nos eventos marcados.
        </p>
